                        ...
                        <div className={styles.resultGrid}>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.matchProb} (
                                    {data.data.matchProb
                                        ? (1 / data.data.matchProb).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            ...
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.gamesOver21_5} (
                                    {data.data.gamesOver21_5
                                        ? (1 / data.data.gamesOver21_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.gamesOver22_5} (
                                    {data.data.gamesOver22_5
                                        ? (1 / data.data.gamesOver22_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.gamesOver23_5} (
                                    {data.data.gamesOver23_5
                                        ? (1 / data.data.gamesOver23_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.homeAH2_5} (
                                    {data.data.homeAH2_5
                                        ? (1 / data.data.homeAH2_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.homeAH3_5} (
                                    {data.data.homeAH3_5
                                        ? (1 / data.data.homeAH3_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.homeAH4_5} (
                                    {data.data.homeAH4_5
                                        ? (1 / data.data.homeAH4_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.awayAH2_5} (
                                    {data.data.awayAH2_5
                                        ? (1 / data.data.awayAH2_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.awayAH3_5} (
                                    {data.data.awayAH3_5
                                        ? (1 / data.data.awayAH3_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
                            <div className={styles.resultItem}>
                                ...
                                <span>
                                    {data.data.awayAH4_5} (
                                    {data.data.awayAH4_5
                                        ? (1 / data.data.awayAH4_5).toFixed(2)
                                        : "-"}
                                    )
                                </span>
                            </div>
