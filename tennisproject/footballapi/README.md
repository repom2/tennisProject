...
docker compose exec tennisproject poetry run python manage.py elo_rate atp 'grass'

docker compose exec tennisproject poetry run python manage.py predict predict 'atp' 'wimb'
