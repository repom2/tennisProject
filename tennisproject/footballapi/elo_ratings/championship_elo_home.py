...
def championship_elo_home():
    ...
    for match in matches:
        ...
        prob = probability_of_winning(away[0].elo, home_elo)
        ...
        # Loser
        prob = probability_of_winning(away[0].elo, away_elo)
        k = calculate_k_factor(away_games, o, c, s)
        away_elo, away_change = calculate_new_elo(away_elo, away_outcome, prob, k)
