from tennis_api.models import AtpMatch
import pandas as pd
...
def player_stats():
    query = "select *, (SPW + loser_SPW) / 2 as avg_SWP, " \
        ...
        "from tennis_api_atpmatch t inner join tennis_api_atptour e on t.tour_id=e.id " \
        "where " \
