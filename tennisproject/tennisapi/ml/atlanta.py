...
def get_data():
    query = "select \
            ...
            select \
                ...
                round_name, \
                (select elo from tennisapi_atphardelo el where el.player_id=winner_id and el.match_id=b.id) as winner_hardelo, " \
            ...
            "and round_name not ilike 'qualification%' and a.date > '1995-1-1' ) " \
            "ss;"
