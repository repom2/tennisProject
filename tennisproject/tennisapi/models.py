...
class Bet(models.Model):
    ...
    home_elo_hard = models.FloatField(null=True)
    away_elo_hard = models.FloatField(null=True)
    home_elo_clay = models.FloatField(null=True)
    away_elo_clay = models.FloatField(null=True)
    home_elo_grass = models.FloatField(null=True)
    away_elo_grass = models.FloatField(null=True)
    home_elo_hard_games = models.FloatField(null=True)
    away_elo_hard_games = models.FloatField(null=True)
    home_elo_clay_games = models.FloatField(null=True)
